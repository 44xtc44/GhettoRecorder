...
function ajax_switch_radio(radio_btn_id) {
    ...
    xhr.onload = function () {
        ...
        pMsg.style.padding = '10px';
        pMsg.style.color = '#f9f9f9ff';
...
function ajax_title_get() {
    ...
    xhr.onload = function () {
        ...
        pTitle.style.fontFamily = 'PT Sans, arial';
        pTitle.style.padding = '10px';
        pTitle.innerHTML = '';
        pTitle.innerHTML = '[' + glob.playingRadio + '] ' + data.title;
    };
